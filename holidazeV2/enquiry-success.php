...
$enquiriesList = file_get_contents('./client/src/enquiries.json');
...
file_put_contents('./client/src/enquiries.json', $jsonData);
?>

<?php header("Location: http://localhost:3000/BookingConfirmed/"); ?>